            ...
            if (isAttacking) {
                ...
                switch (direction) {
                    case "front":
                        ...
                        g2d.drawImage(flipped_image, playerX, playerY + game_panel.tile_size, game_panel.tile_size, game_panel.tile_size, null);
                        break;
                    case "back":
                        attackY -= range;
                        attackHeight += range;
                        g2d.rotate(-angle, playerX + game_panel.tile_size / 2, playerY + game_panel.tile_size / 2);
                        g2d.drawImage(image, playerX, playerY - game_panel.tile_size, game_panel.tile_size, game_panel.tile_size, null);
                        break;
                    case "left":
                        attackX -= range;
                        attackWidth += range;
                        g2d.rotate(-angle, playerX + game_panel.tile_size / 2, playerY + game_panel.tile_size / 2);
                        g2d.drawImage(mirrored_image, playerX - game_panel.tile_size, playerY, game_panel.tile_size, game_panel.tile_size, null);
                        break;
                    case "right":
                        attackX += game_panel.tile_size;
                        attackWidth += range;
                        g2d.rotate(angle, playerX + game_panel.tile_size / 2, playerY + game_panel.tile_size / 2);
                        g2d.drawImage(image, playerX + game_panel.tile_size, playerY, game_panel.tile_size, game_panel.tile_size, null);
                        break;
                }
                ...
                for (Entity entity : game_panel.getEntities()) {
                    if (entity instanceof Monster) {
                        ...
                        //g2d.draw(attackArea);
                        java.awt.Rectangle monsterArea = new java.awt.Rectangle(monster.x+game_panel.tile_size/4, monster.y+game_panel.tile_size/2, game_panel.tile_size, game_panel.tile_size);
